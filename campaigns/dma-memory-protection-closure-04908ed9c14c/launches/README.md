...
```text
campaigns/dma-memory-protection-closure-04908ed9c14c/launches/<launch-id>/launch-authority.json
```
...
```bash
swb campaign launch-authority --workspace <design-worktree> --support-profile-id opentitan-dma --campaign-id dma-memory-protection-closure-04908ed9c14c --launch-id <launch-id> --lock campaigns/dma-memory-protection-closure-04908ed9c14c/runtime-lock.json --bundle campaigns/dma-memory-protection-closure-04908ed9c14c/mcp-bundle.json --recorded-by <controller-id> --authority-boundary "<accepted runtime/bundle boundary>"
```
...
```bash
swb campaign check --workspace <design-worktree> --support-profile-id opentitan-dma --campaign-id dma-memory-protection-closure-04908ed9c14c --launch-id <launch-id> --fetch
```
