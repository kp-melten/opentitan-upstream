...
Campaign ID: `dma-memory-protection-closure-04908ed9c14c`
Support profile ID: `opentitan-dma`
Campaign artifact root: `campaigns/dma-memory-protection-closure-04908ed9c14c`
...
```bash
swb campaign check --workspace <design-worktree> --support-profile-id opentitan-dma --campaign-id dma-memory-protection-closure-04908ed9c14c --fetch
```
...
records under the git-owned `campaigns/dma-memory-protection-closure-04908ed9c14c/` subtree. Current SWB agent-runtime helpers accept the
campaign-owned surfaces `artifacts/`, `checks/`, `evidence/`,
`tool-runs/`, and `verifier/` below `campaigns/dma-memory-protection-closure-04908ed9c14c/`.
