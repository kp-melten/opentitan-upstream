...
| C2 | `d1038f6154ed90667756fba454fe023bc04bf8be` | `c9619cb7610e9554eae1b812a5fadd7fd9fa32ac` | M8 EV-RTL-LINT, EV-DV-LINT, EV-XSIM-FOCUSED and verifier/m8; EV-UVM-DIRECTED pending | accepted_implementation_checkpoint | strict all-request source boundary plus independently reviewed exact-revision static/focused checks | no full UVM, regression, or promotion claim |
...
- Status: independently accepted for the non-promotion implementation
  checkpoint; full UVM execution pending.
- Non-claims: no promotion, full regression, coverage, formal, integration,
